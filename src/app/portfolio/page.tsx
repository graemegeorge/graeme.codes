      ...
      <div className="relative z-10 min-h-screen flex items-center justify-center flex-col flex-1 px-8 py-24">
        <div className="w-full max-w-3xl">
          <div className="flex flex-col items-center justify-center mb-12 gap-2">
            <div className="text-4xl font-inter mb-2 theme-text-primary">Portfolio</div>
                ...
                <div className="flex items-start justify-between gap-4">
                  <div className="flex-1">
                    <div className="flex items-center gap-2 mb-3">
                      <Briefcase className="w-4 h-4 transition-colors duration-300 theme-text-muted theme-accent-hover" />
                  ...
                  >
                    <ExternalLink className="w-4 h-4 transition-colors duration-300 theme-text-muted-dark theme-accent-hover" />
                  </a>
                </div>
              </div>
            ))}
